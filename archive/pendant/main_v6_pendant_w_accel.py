...
from digitalio import DigitalInOut, Direction # for on-board LED
import busio # for accellerometer
import adafruit_lis3dh # for accellerometer
import random
...
while True:
    ...
    # show an initial yellow at a faded state ... meaning no connection
    ...
    if hr_connection and hr_connection.connected:
        ...
        while hr_connection.connected:
            ...
            if bpm_raw != 0: # prevent from divide by zero
                ...
                if bpm_raw > fireworks_threshold and not dark_state:
                    fireworks()
                    continue
                ...
                if dark_state:
                    # make dark and skip the rest of the loop
                    fill_color_simple ((0,0,0))
                    time.sleep(1)
                    continue
